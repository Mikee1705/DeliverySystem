        ...
        <?php while ($row = mysqli_fetch_array($display)) { ?>
            <tr>
                ...
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    ...
                    <td><input type="text" name="cname" value="<?php echo htmlspecialchars($row['CUST_NAME']); ?>" required>
                    </td>
                    <td><input type="text" name="number" value="<?php echo htmlspecialchars($row['CUST_PHONE_NUMBER']); ?>"
                            required></td>
                    <td><input type="text" name="location" value="<?php echo htmlspecialchars($row['CUST_LOCATION']); ?>"
                            required></td>
